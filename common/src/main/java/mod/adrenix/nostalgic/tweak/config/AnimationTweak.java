...
public interface AnimationTweak
{
    ...
    TweakFlag OLD_MOB_HEAD_BODY_TURN = TweakFlag.client(true, AnimationGroup.MOB).build();
    ...
    TweakNumber<Integer> VERTICAL_BOBBING_INTENSITY = TweakNumber.client(100, AnimationGroup.PLAYER).slider(0, 100, SliderType.INTENSITY).newForUpdate().build();
