...
public class SliderTweak
{
    ...
    private void effectsRenderer(SliderWidget slider, GuiGraphics graphics, int mouseX, int mouseY, float partialTick)
    {
        ...
        GuiSprite empty = isHearts ? GameSprite.EMPTY_HEART : ModSprite.STAMINA_EMPTY;
        GuiSprite full = isHearts ? GameSprite.FULL_HEART : ModSprite.STAMINA_LEVEL;
        GuiSprite half = isHearts ? GameSprite.HALF_HEART : ModSprite.STAMINA_LEVEL_HALF;
