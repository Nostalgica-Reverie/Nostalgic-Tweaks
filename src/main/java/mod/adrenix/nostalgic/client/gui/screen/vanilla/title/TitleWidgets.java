...
class TitleWidgets implements WidgetManager {
    ...
    private boolean hasModsButton() {
        /*CandyTweak.INCLUDE_MODS_ON_TITLE.get()*/
        return GuiUtil.modListScreen != null; //TODO
    }
    ...
    private void gotoOptions() {
        if (this.minecraft != null)
            this.minecraft.setScreen(new OptionsScreen(this.titleScreen, this.minecraft.options, this.minecraft.level != null));
    }
    ...
    private void setAlphaLayout() {
        ...
        boolean canStop = true;//CandyTweak.ADD_QUIT_BUTTON.get(); //TODO
    ...
    private void setReleaseLayout() {
        ...
        if (true/*!CandyTweak.REMOVE_TITLE_LANGUAGE_BUTTON.get()*/) { //TODO
            ButtonWidget.create()
