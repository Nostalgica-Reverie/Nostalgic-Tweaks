    ...
    private ButtonBuilder getColorSquareFactory(Color color) {
        ...
        return ButtonWidget.create()
                ...
                .renderer((button, graphics, mouseX, mouseY, partialTick) -> {
                    ...
                    graphics.pose().translate(button.getX(), button.getY());
                    ...
                    graphics.outline(0, 0, size, size, border);
                    ...
                    if (color.isTransparent()) {
                        ...
                        for (int row = 1; row <= height; row++) {
                            ...
                            for (int i = 1; i <= width; i++)
                                graphics.fill(i, row, i + 1, row + 1, MathUtil.isEven(i) ? primary.get() : secondary.get());
                        }
                    }

                    graphics.fill(1, 1, size - 1, size - 1, color.get());
