...
public class PauseWidgets implements WidgetManager {
    ...
    private boolean isMultiplayer() {
        return false;//NetUtil.isMultiplayer() && !NetUtil.isLocalHost(); //TODO
    }
    ...
    private void saveOrQuit() {
        this.minecraft.getReportingContext().draftReportHandled(this.minecraft, this.pauseScreen,
                        () -> this.minecraft.disconnectFromWorld(ClientLevel.DEFAULT_QUIT_MESSAGE), true);
    }
    ...
    private void gotoOptions() {
        if (this.minecraft != null)
            this.minecraft.setScreen(new OptionsScreen(this.pauseScreen, this.minecraft.options, this.minecraft.level != null));
    }
    ...
    private void setAlphaLayout() {
        ...
        if (true/*CandyTweak.INCLUDE_MODS_ON_PAUSE.get()*/ && GuiUtil.modListScreen != null) { //TODO
    ...
    private void setLanLayout() {
        ...
        ButtonWidget lan = ButtonWidget.create(Lang.Vanilla.MENU_LAN)
                .rightOf(options, WIDGET_MARGIN)
                .width(SMALL_BUTTON)
//                .disableIf(NetUtil::isMultiplayer) //TODO
