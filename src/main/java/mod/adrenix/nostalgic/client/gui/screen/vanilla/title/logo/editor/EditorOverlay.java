...
public abstract class EditorOverlay {
     ...
     */
    private static void renderLeftTransparent(ButtonWidget button, GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.fill(button.getX(), button.getY(), button.getX() + 2, button.getEndY(), line.get()); //TODO, float is gone. investigate if this impacts stuff
    }
