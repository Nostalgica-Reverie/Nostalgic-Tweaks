...
//     */
//    private void render(ButtonWidget button, GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
...
//            graphics.fill(button.getX(), button.getY(), button.getEndX(), button.getEndY(), color);
//
