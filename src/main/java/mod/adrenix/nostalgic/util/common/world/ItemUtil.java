...
public abstract class ItemUtil {
    ...
    public static Optional<Item> getOptionalItem(String resourceKey) {
        return BuiltInRegistries.ITEM.getOptional(Identifier.tryParse(resourceKey));
    }
    ...
    public static Item getItem(String resourceKey) {
        return BuiltInRegistries.ITEM.getValue(Identifier.tryParse(resourceKey));
    }
    ...
    public static Block getBlock(String resourceKey) {
        return BuiltInRegistries.BLOCK.getValue(Identifier.tryParse(resourceKey));
    }
