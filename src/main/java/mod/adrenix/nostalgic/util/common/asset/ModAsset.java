...
public abstract class ModAsset {
     ...
     * @return A new {@link Identifier} instance where the full-path appears as {@code modId:$path} where
     ...
     * @return A new {@link Identifier} instance where the full-path appears as {@code modId:textures/$path} where
     * {@code $path} is the given {@code path} argument.
     */
     ...
     * @return A new {@link Identifier} instance where the full-path appears as {@code modId:textures/icon/$path}
     * where {@code $path} is the given {@code path} argument.
     */
    public static Identifier icon(String path) {
     ...
     * @return A new {@link Identifier} instance where the returned-path references a location on the gui atlas
    ...
    public static Identifier supporter(String username) {
